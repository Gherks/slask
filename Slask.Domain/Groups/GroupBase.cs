...
namespace Slask.Domain.Groups
{
    public partial class GroupBase
    {
        ...
        public bool AddPlayerReferences(List<PlayerReference> playerReferences)
        {
            ...
            return FillMatchesWithPlayerReferences(playerReferences);
        }
        ...
        public List<PlayerReference> GetPlayerReferences()
        {
            ...
            foreach (Match match in Matches)
            {
                try
                {
                    playerReferenceDictionary.Add(match.Player1.PlayerReference.Name, match.Player1.PlayerReference);
                }
                catch (Exception) { }

                try
                {
                    playerReferenceDictionary.Add(match.Player2.PlayerReference.Name, match.Player2.PlayerReference);
                }
                catch (Exception) { }
            }
        ...
        public virtual bool ConstructGroupLayout(int playersPerGroupAmount)
        {
