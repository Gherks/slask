...
namespace Slask.Application.Interfaces.Persistence
{
    public interface TournamentRepositoryInterface
    {
        ...
        IEnumerable<PlayerReference> GetPlayerReferencesInTournament(Guid id);
        IEnumerable<PlayerReference> GetPlayerReferencesInTournament(string name);
        Better AddBetterToTournament(Tournament tournament, User user);
        bool RemoveBetterFromTournament(Tournament tournament, Guid betterId);
        bool RemoveBetterFromTournament(Tournament tournament, string betterName);
        IEnumerable<Better> GetBettersInTournament(Guid id);
        IEnumerable<Better> GetBettersInTournament(string name);
