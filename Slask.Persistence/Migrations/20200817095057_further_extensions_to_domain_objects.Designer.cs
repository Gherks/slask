...
namespace Slask.Persistence.Migrations
{
    ...
    [Migration("20200817095057_further_extensions_to_domain_objects")]
    partial class further_extensions_to_domain_objects
    {
            ...
            modelBuilder.Entity("Slask.Domain.Groups.GroupBase", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("GroupBase");
                });
            ...
            modelBuilder.Entity("Slask.Domain.Groups.GroupTypes.BracketGroup", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("BracketGroup");
                });
