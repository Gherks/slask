...
Scenario: When bracket has uneven participants the first match should contain two players and parent should contain one
	#
...
Scenario: Bracket progression goes as expected
	...
	# | 7 vs 8 |
	#
	#  Match 3		 Match 6		 Match 7
	# | 5 vs 6 |	| 5 vs 7 |		| 1 vs 5 |
	#
	#  Match 2		 Match 5
	# | 3 vs 4 |	| 1 vs 3 |
	#
