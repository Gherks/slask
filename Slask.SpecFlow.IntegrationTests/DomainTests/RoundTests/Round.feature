...
Scenario: PlayState is set to IsPlaying when at least one group has started but not all
	Given a tournament named "GSL 2019" has been created
		And created tournament 0 adds rounds
			| Round type | Round name      | Best of | Advancing per group count | Players per group count |
			| Bracket    | Bracket round 1 | 3       | 1                         | 4                       |
	...
	When created groups within created tournament is played out and betted on
		| Tournament index | Round index | Group index |
		| 0                | 0           | 0           |
	Then play state of round 0 is set to "IsPlaying"

Scenario: PlayState set to IsFinished when all groups has finished
	Given a tournament named "GSL 2019" has been created
		And created tournament 0 adds rounds
			| Round type | Round name      | Best of | Advancing per group count | Players per group count |
			| Bracket    | Bracket round 1 | 3       | 1                         | 4                       |
	...
	When created groups within created tournament is played out and betted on
			...
			| 0                | 0           | 0           |
			| 0                | 0           | 1           |
	Then play state of round 0 is set to "IsFinished"
